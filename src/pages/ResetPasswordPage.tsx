        ...
        <div className="relative z-10 w-full max-w-md px-4">
          <div className="rounded-2xl border border-white/20 bg-black/40 p-8 backdrop-blur-xl text-center">
            ...
            <h2 className="mb-2 text-lg font-bold text-white">
              {token ? t('loginUpdateSuccess') : t('loginResetSuccess')}
            </h2>
            <p className="mb-6 text-sm text-white/60">
              {token ? t('loginUpdateHint') : t('loginResetHint')}
            </p>
            <button
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="rounded-2xl border border-white/20 bg-black/40 p-8 backdrop-blur-xl">
          <div className="mb-8 text-center">
            <h1 className="text-xl font-bold text-white md:text-2xl">{t('loginReset')}</h1>
            <p className="mt-1 text-sm text-white/60">
              {token ? t('loginResetNewPassword') : t('loginResetEmail')}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={busy || (!token && !email) || (!!token && !password)}
